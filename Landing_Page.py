...
def landing_page():
    ...
    with col1:
        with st.container():
            st.markdown("<h3 style='height:48px; text-align: center;'>Interactive Dashboard</h3>", unsafe_allow_html=True)
    ...
    with col2:
        with st.container():
            st.markdown("<h3 style='height:48px; text-align: center;'>Rapid Forecast</h3>", unsafe_allow_html=True)
            st.markdown("It allows you to forecast ridership trends ahead of any number of days up to 365 to make informed decision.")

    col3, _ = st.columns(2)
    with col3:
        with st.container():
            st.markdown("<h3 style='height:48px; text-align: center;'>Anomaly Detection</h3>", unsafe_allow_html=True)
    ...
    with col4:
        with st.container():
            st.markdown("<h3 style='height:84px; text-align: center;'>Optimizing Services</h3>", unsafe_allow_html=True)
    ...
    with col5:
        with st.container():
            st.markdown("<h3 style='height:84px; text-align: center;'>Reducing Environmental Pollutions</h3>", unsafe_allow_html=True)
    ...
    with col6:
        with st.container():
            st.markdown("<h3 style='height:84px; text-align: center;'>Optimizing Bus Schedules</h3>", unsafe_allow_html=True)
